...
async function testAdjectiveEndpoints() {
  try {
    ...
    try {
      const response1 = await axios.post('http://localhost:3000/api/v1/explore/adjectives/select', {
        targetUserId: 30,
        adjective: 'Smart'
      }, { headers });
    ...
    try {
      const response2 = await axios.post('http://localhost:3000/api/v1/explore/adjectives/select', {
        targetUserId: 30,
    ...
    console.log('\n📝 Test 3: Enhanced endpoint with "Smart"');
    try {
      const response3 = await axios.post('http://localhost:3000/api/v1/enhanced-explore/adjectives/select', {
        targetUserId: 30,
        adjective: 'Smart'
      }, { headers });
    ...
    console.log('\n📝 Test 4: Enhanced endpoint with "Disciplined"');
    try {
      const response4 = await axios.post('http://localhost:3000/api/v1/enhanced-explore/adjectives/select', {
        targetUserId: 30,
        adjective: 'Disciplined'
      }, { headers });
