...
app.use('/api/v1/quiz', quiz_routes_1.default); // Add quiz routes
app.use('/api/v1/dinner-preferences', dinnerPreferences_routes_1.default); // Add dinner preferences routes
app.use('/api/v1/dinner-events', dinnerEvents_routes_1.default); // Add dinner events routes
exports.default = app;
