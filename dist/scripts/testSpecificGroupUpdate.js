...
async function testSpecificGroupUpdate() {
    ...
    try {
        ...
        try {
            const updateResponse = await axios_1.default.put(`${BASE_URL}/api/v1/groups/3`, {
            ...
            console.log('❌ Update request failed:', (_a = error.response) === null || _a === void 0 ? void 0 : _a.status);
