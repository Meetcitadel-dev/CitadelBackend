...
const makeAuthRequest = async (method, url, data, tokenIndex = 0) => {
    ...
    try {
        ...
        console.error(`❌ Error in ${method} ${url}:`, ((_a = error.response) === null || _a === void 0 ? void 0 : _a.data) || error.message);
        throw error;
    }
};
// Test authentication
const testAuthentication = async () => {
    ...
    for (let i = 0; i < testUsers.length; i++) {
        try {
            ...
            console.log(`⚠️ User ${i + 1} authentication failed:`, ((_b = (_a = error.response) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.message) || error.message);
        }
    }
};
