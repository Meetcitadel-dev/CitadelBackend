            ...
            if (testConversation) {
                ...
                if (otherUser) {
                    ...
                    console.log('✅ User found:', {
                        ...
                        profileImage: ((_b = (_a = userWithImages.images) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.cloudfrontUrl) || null
                    });
                    const result = {
                        success: true,
                        conversation: {
                            ...
                            profileImage: ((_d = (_c = userWithImages.images) === null || _c === void 0 ? void 0 : _c[0]) === null || _d === void 0 ? void 0 : _d.cloudfrontUrl) || null
                        }
                    };
