...
async function testGroupChat() {
    ...
    try {
        ...
        const messagesResponse = await axios_1.default.get(`${API_BASE}/groups/${testGroup.id}/messages`, { headers });
        console.log('✅ Messages retrieved:', messagesResponse.data.messages.length);
        console.log('📨 Recent messages:');
        messagesResponse.data.messages.slice(0, 3).forEach((msg, index) => {
        ...
        const sendResponse = await axios_1.default.post(`${API_BASE}/groups/${testGroup.id}/messages`, { content: newMessage }, { headers });
        ...
        const updatedMessagesResponse = await axios_1.default.get(`${API_BASE}/groups/${testGroup.id}/messages`, { headers });
        ...
        const readResponse = await axios_1.default.post(`${API_BASE}/groups/${testGroup.id}/messages/read`, {}, { headers });
