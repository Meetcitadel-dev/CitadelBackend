...
async function testChatEndpoints() {
    ...
    try {
        ...
        try {
            ...
            console.error('❌ Matches endpoint failed:', ((_a = error.response) === null || _a === void 0 ? void 0 : _a.data) || error.message);
        }
        ...
        try {
            ...
            console.error('❌ Active endpoint failed:', ((_b = error.response) === null || _b === void 0 ? void 0 : _b.data) || error.message);
        }
    }
    catch (error) {
