...
async function testInteractionSystem() {
    try {
        ...
        allInteractions.forEach((interaction, index) => {
            ...
            console.log(`   ${index + 1}. ${interaction.interactionType} → ${(targetUser === null || targetUser === void 0 ? void 0 : targetUser.name) || `User ${interaction.targetUserId}`}`);
        });
        ...
        interactedUserIds.forEach((userId, index) => {
            ...
            console.log(`   ${index + 1}. ${(user === null || user === void 0 ? void 0 : user.name) || `User ${userId}`}`);
        });
