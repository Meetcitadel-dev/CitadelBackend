...
async function createConversationsForMatches() {
    try {
        ...
        for (const match of matches) {
            ...
            if (created) {
                console.log(`✅ Created new conversation with ${otherUser === null || otherUser === void 0 ? void 0 : otherUser.name} (ID: ${conversation.id})`);
                // Add a test message
                await message_model_1.default.create({
                    conversationId: conversation.id,
                    senderId: userId,
                    text: `Hi ${otherUser === null || otherUser === void 0 ? void 0 : otherUser.name}! Nice to meet you!`,
                    status: 'sent'
                });
                console.log(`✅ Added test message to conversation with ${otherUser === null || otherUser === void 0 ? void 0 : otherUser.name}`);
            }
            else {
                console.log(`⏭️  Conversation already exists with ${otherUser === null || otherUser === void 0 ? void 0 : otherUser.name} (ID: ${conversation.id})`);
            }
        }
