...
async function testLoginAPI() {
    ...
    try {
        ...
        const checkUserResponse = await axios_1.default.post(`${BASE_URL}/check-user`, {
        ...
        const sendOtpResponse = await axios_1.default.post(`${BASE_URL}/send-otp`, {
            email: 'test@university.edu',
            isLogin: true
        });
...
async function testErrorCases() {
    ...
    try {
        ...
        const invalidEmailResponse = await axios_1.default.post(`${BASE_URL}/check-user`, {
    ...
    try {
        ...
        const nonExistentUserResponse = await axios_1.default.post(`${BASE_URL}/check-user`, {
    ...
    try {
        ...
        const missingEmailResponse = await axios_1.default.post(`${BASE_URL}/check-user`, {});
