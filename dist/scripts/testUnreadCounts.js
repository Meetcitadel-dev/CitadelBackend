...
async function loginUser(email, password) {
    ...
    try {
        ...
        console.error(`Login failed for ${email}:`, ((_a = error.response) === null || _a === void 0 ? void 0 : _a.data) || error.message);
        throw error;
    }
}
...
async function testUnreadCounts() {
    ...
    try {
        ...
        console.log(`📊 User3's unread count for group: ${(group === null || group === void 0 ? void 0 : group.unreadCount) || 0}`);
