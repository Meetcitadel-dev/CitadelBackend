...
async function testAdjectiveLogic3() {
    ...
    try {
        ...
        const ankitViewResponse = await axios_1.default.get('http://localhost:3000/api/v1/enhanced-explore/adjectives/available/20', { headers: ankitHeaders });
        ...
        try {
            ...
            const user20ViewResponse = await axios_1.default.get('http://localhost:3000/api/v1/enhanced-explore/adjectives/available/15', { headers: user20Headers });
            ...
            console.log('\n📝 Test 4: User 20 selects "Creative" for Ankit');
            const user20Selection = await axios_1.default.post('http://localhost:3000/api/v1/enhanced-explore/adjectives/select', {
                targetUserId: 15,
                adjective: 'Creative'
            ...
            const matchStateResponse = await axios_1.default.get('http://localhost:3000/api/v1/enhanced-explore/matches/state/15', { headers: user20Headers });
        ...
        const nisargViewResponse = await axios_1.default.get('http://localhost:3000/api/v1/enhanced-explore/adjectives/available/25', { headers: nisargHeaders });
        ...
        try {
            ...
            const user25ViewResponse = await axios_1.default.get('http://localhost:3000/api/v1/enhanced-explore/adjectives/available/30', { headers: user25Headers });
