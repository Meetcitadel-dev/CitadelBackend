    ...
    async verifyGroupAccess() {
        ...
        for (const user of this.users) {
            try {
                ...
                console.log(`❌ User ${user.name} cannot access group ${this.testGroupId}:`, ((_b = (_a = error.response) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.message) || error.message);
            }
        }
        console.log('');
    }
