...
function verifyTokens() {
    ...
    try {
        ...
        const decoded1 = jsonwebtoken_1.default.verify(TOKEN1, process.env.JWT_SECRET || 'secret');
    ...
    try {
        ...
        const decoded2 = jsonwebtoken_1.default.verify(TOKEN2, process.env.JWT_SECRET || 'secret');
