...
const calculateMatchScore = (user1, user2) => {
    ...
    else if (((_a = user1.university) === null || _a === void 0 ? void 0 : _a.country) === ((_b = user2.university) === null || _b === void 0 ? void 0 : _b.country) &&
        user1.degree === user2.degree &&
        user1.year === user2.year) {
        score = 0.3;
    }
    // Same city + same year (Score: 0.2)
    else if (((_c = user1.university) === null || _c === void 0 ? void 0 : _c.country) === ((_d = user2.university) === null || _d === void 0 ? void 0 : _d.country) &&
        user1.year === user2.year) {
        score = 0.2;
    }
    // Same city (Score: 0.1)
    else if (((_e = user1.university) === null || _e === void 0 ? void 0 : _e.country) === ((_f = user2.university) === null || _f === void 0 ? void 0 : _f.country)) {
        score = 0.1;
    }
    return score;
};
async function testExploreSystem() {
    ...
    try {
        ...
        console.log(`   University: ${(_a = yourProfile.university) === null || _a === void 0 ? void 0 : _a.name}`);
        console.log(`   Degree: ${yourProfile.degree}`);
        console.log(`   Year: ${yourProfile.year}`);
        console.log(`   Country: ${(_b = yourProfile.university) === null || _b === void 0 ? void 0 : _b.country}\n`);
        // Get all test users
        ...
        const profilesWithScores = testUsers.map(user => {
            ...
            return {
                name: user.name,
                university: (_a = user.university) === null || _a === void 0 ? void 0 : _a.name,
                degree: user.degree,
                year: user.year,
                country: (_b = user.university) === null || _b === void 0 ? void 0 : _b.country,
                score: score,
...
function getMatchReason(score, user1, user2) {
    var _a, _b, _c, _d, _e, _f;
    if (score === 1.0) {
        return `Perfect match! Same university (${(_a = user2.university) === null || _a === void 0 ? void 0 : _a.name}), same year (${user2.year}), same degree (${user2.degree})`;
    }
    else if (score === 0.7) {
        return `Great match! Same university (${(_b = user2.university) === null || _b === void 0 ? void 0 : _b.name}), same year (${user2.year})`;
    }
    else if (score === 0.4) {
        return `Good match! Same university (${(_c = user2.university) === null || _c === void 0 ? void 0 : _c.name})`;
    }
    else if (score === 0.3) {
        return `Decent match! Same country (${(_d = user2.university) === null || _d === void 0 ? void 0 : _d.country}), same degree (${user2.degree}), same year (${user2.year})`;
    }
    else if (score === 0.2) {
        return `Okay match! Same country (${(_e = user2.university) === null || _e === void 0 ? void 0 : _e.country}), same year (${user2.year})`;
    }
    else if (score === 0.1) {
        return `Basic match! Same country (${(_f = user2.university) === null || _f === void 0 ? void 0 : _f.country})`;
    }
    else {
