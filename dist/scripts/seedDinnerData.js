...
async function seedDinnerData() {
    try {
        ...
        await personalityQuiz_model_1.default.deleteMany({});
        console.log('🗑️  Cleared existing quiz questions');
        // Insert quiz questions
        await personalityQuiz_model_1.default.insertMany(quizQuestions);
        ...
        await dinnerEvent_model_1.default.deleteMany({});
        console.log('🗑️  Cleared existing dinner events');
        // Insert dinner events
        await dinnerEvent_model_1.default.insertMany(dinnerEvents);
