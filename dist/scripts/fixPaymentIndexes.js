...
async function fixPaymentIndexes() {
    try {
        ...
        console.log('\n📋 Current indexes:');
        const indexes = await payment_model_1.default.collection.getIndexes();
        console.log(JSON.stringify(indexes, null, 2));
        // Drop the old unique indexes that don't have partial filter
        console.log('\n🗑️  Dropping old indexes...');
        try {
            await payment_model_1.default.collection.dropIndex('razorpayOrderId_1');
        ...
        try {
            await payment_model_1.default.collection.dropIndex('razorpayPaymentId_1');
        ...
        try {
            await payment_model_1.default.collection.dropIndex('phonepeOrderId_1');
        ...
        try {
            await payment_model_1.default.collection.dropIndex('phonepePaymentId_1');
        ...
        await payment_model_1.default.collection.createIndex({ razorpayOrderId: 1 }, {
            unique: true,
        ...
        await payment_model_1.default.collection.createIndex({ razorpayPaymentId: 1 }, {
            unique: true,
        ...
        await payment_model_1.default.collection.createIndex({ phonepeOrderId: 1 }, {
            unique: true,
        ...
        await payment_model_1.default.collection.createIndex({ phonepePaymentId: 1 }, {
            unique: true,
        ...
        console.log('\n📋 New indexes:');
        const newIndexes = await payment_model_1.default.collection.getIndexes();
