...
async function testUserProfile() {
    ...
    try {
        ...
        const response = await axios_1.default.get(`${BASE_URL}/users/${testUsername}`, {
            headers: {
        ...
        if (data.connectionsCount !== undefined && data.mutualConnectionsCount !== undefined) {
            ...
            console.log(`Connections Array Length: ${((_a = data.connections) === null || _a === void 0 ? void 0 : _a.length) || 0}`);
        }
        else {
        ...
        console.error('Error testing user profile:', ((_b = error.response) === null || _b === void 0 ? void 0 : _b.data) || error.message);
    }
}
async function testMutualConnections() {
    ...
    try {
        ...
        const response = await axios_1.default.get(`${BASE_URL}/users/${testUsername}/mutual-friends`, {
            headers: {
                'Authorization': `Bearer ${token}`,
                'Content-Type': 'application/json'
            }
        ...
        console.error('Error testing mutual connections:', ((_a = error.response) === null || _a === void 0 ? void 0 : _a.data) || error.message);
    }
}
// Run tests
