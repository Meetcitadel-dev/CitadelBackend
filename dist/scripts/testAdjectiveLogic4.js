...
async function testAdjectiveLogic4() {
    try {
        ...
        const ankitViewResponse2 = await axios_1.default.get('http://localhost:3000/api/v1/enhanced-explore/adjectives/available/20', { headers: ankitHeaders });
        ...
        console.log('\n📝 Test 6: Nisarg views user 25\'s profile again');
        const nisargViewResponse2 = await axios_1.default.get('http://localhost:3000/api/v1/enhanced-explore/adjectives/available/25', { headers: nisargHeaders });
