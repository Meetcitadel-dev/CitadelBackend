...
async function testExploreAPI() {
    ...
    try {
        ...
        try {
            ...
            console.log('❌ Failed to fetch profiles:', ((_a = error.response) === null || _a === void 0 ? void 0 : _a.data) || error.message);
        }
        ...
        try {
            ...
            console.log(`   Status: ${((_b = statusResponse.data.connectionState) === null || _b === void 0 ? void 0 : _b.status) || 'not_connected'}`);
        }
        catch (error) {
            console.log('❌ Failed to fetch connection status:', ((_c = error.response) === null || _c === void 0 ? void 0 : _c.data) || error.message);
        }
        ...
        try {
            ...
            console.log('❌ Failed to select adjective:', ((_d = error.response) === null || _d === void 0 ? void 0 : _d.data) || error.message);
        }
        ...
        try {
            ...
            console.log('❌ Failed to fetch adjective matches:', ((_e = error.response) === null || _e === void 0 ? void 0 : _e.data) || error.message);
        }
        ...
        try {
            ...
            console.log(`   Status: ${(_f = connectResponse.data.connectionState) === null || _f === void 0 ? void 0 : _f.status}`);
        }
        catch (error) {
            console.log('❌ Failed to send connection request:', ((_g = error.response) === null || _g === void 0 ? void 0 : _g.data) || error.message);
        }
